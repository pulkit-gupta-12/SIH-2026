# Generated by Django 5.1.15 on 2026-08-27 13:27
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(choices=[('citizen', 'Citizen'), ('field_officer', 'Field Officer'), ('state_controller', 'State Controller'), ('national_admin', 'National Admin'), ('business', 'Business'), ('ecommerce_partner', 'E-commerce Partner'), ('rule_admin', 'Rule Admin')], max_length=30, unique=True)),
            ],
            options={
                'db_table': 'roles',
            },
